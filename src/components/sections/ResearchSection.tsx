...
const PUBLICATIONS: Publication[] = [
    {
        ...
        publisher: "Multidisciplinary Research Publishers",
        year: "2026",
        date: "July 2026",
        type: "Journal",
        doi: "10.5281/zenodo.21696248",
        doiUrl: "https://doi.org/10.5281/zenodo.21696248",
        researchGateUrl: "https://www.researchgate.net/publication/410953318_A_Quantitative_Study_on_the_Impact_of_the_Use_of_ChatGPT_and_Google_Gemini_on_the_Academic_Performance_of_IT_Undergraduates_at_NIIBS_Campus",
        googleScholarUrl: "https://scholar.google.com/citations?view_op=view_citation&hl=en&user=LoIBv4AAAAAJ&citation_for_view=LoIBv4AAAAAJ:u-x6o8ySG0sC",
        pdfUrl: "https://www.jrte.org/wp-content/uploads/2026/07/A-Quantitative-Study-on-the-Impact-of-the-Use-of-ChatGPT-and-Google-Gemini-on-the-Academic-Performance-of-IT-Undergraduates-at-NIIBS-Campus.pdf",
...
export default function ResearchSection({ hideHeader = false }: { hideHeader?: boolean }) {
                        ...
                        filteredPublications.map((pub, idx) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Paper Title */}
                                    <h3 className="text-2xl sm:text-3xl font-medium text-white group-hover:text-theme-primary transition-colors leading-snug font-poppins mb-4">
                                        {pub.doiUrl ? (
